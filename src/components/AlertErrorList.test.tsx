...
describe("AlertErrorList", () => {
  ...
  it("should not render if the error list is empty or contains only empty errors", () => {
    ...
    const { container: containerEmptyList } = render(
      <AlertErrorList {...propsWithEmptyList} />,
    );
    ...
    const { container: containerEmptyErrors } = render(
      <AlertErrorList {...propsWithEmptyErrors} />,
    );
